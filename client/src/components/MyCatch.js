  ...
  <div class="relative max-w-screen-xl px-4 py-32 mx-auto lg:h-screen lg:items-center lg:flex">
    <div class="max-w-xl text-center sm:text-left">
      ...
      <div class="flex flex-wrap gap-4 mt-8 text-center">
        ...
        <a class="block w-full px-12 py-3 text-sm font-medium bg-white rounded shadow text-blue-600 sm:w-auto hover:text-blue-700 active:text-blue-500 focus:outline-none focus:ring" href="/about">
          Learn More
        </a>
      </div>
    </div>
